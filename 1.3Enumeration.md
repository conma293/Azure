...
#### AzureAD Module
__AzureAD is a PowerShell module from Microsoft for managing Azure AD.__
NOTE:- _AAD Graph is more stealhy than MS Graph due to the latters additional security features_
