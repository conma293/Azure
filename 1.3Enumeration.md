...
- **App Registration**: Called "apps" in powershell - you want to use AzureAD Authentication to be able to access the app; treated as config - they can not be assigned any role..
