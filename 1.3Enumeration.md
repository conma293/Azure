...
=> if a low privilege user owns a high privilege application, that user is an attractive target, and it might not be immediately obvious to defenders either!
```
