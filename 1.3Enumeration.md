...
- If you have GA or are the owner of the app, you can add your own secret (password), or federated identity; and acess the environment as the application with those created creds
