...
**=> if a low privilege user owns a high privilege object (i.e., an application), that user is an attractive target, and it might not be immediately obvious to defenders either!**
```
