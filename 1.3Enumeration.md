...
- [Az Powershell](https://github.com/conma293/Azure/blob/main/1.3Enumeration.md#enumeration----az-powershell) - enumerate Az Resources as well as Azure AD
  - [az wildcards](https://github.com/conma293/Azure/blob/main/1.3Enumeration.md#az-wildcards)
...
- An application object is the global representation of an app; aka app registration.
```Get-AzADApplication```
