- [Logging on with tokens](https://github.com/conma293/Azure/blob/main/OAuth.md#logging-on-with-tokens)
  -  [Using Tokens with CLI tools - Az PowerShell](https://github.com/conma293/Azure/blob/main/OAuth.md#using-tokens-with-cli-tools---az-powershell) ([Az Powershell](https://github.com/conma293/Azure/blob/main/2.1_Enumeration.md#enumeration----az-powershell) can request and use tokens)
